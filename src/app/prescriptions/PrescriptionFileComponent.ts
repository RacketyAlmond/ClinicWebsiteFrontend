...
@Component({
  ...
  templateUrl: './prescription-file.component.html', // Ensure the template path is correct
  styleUrls: ['./prescription-file.component.css']   // Ensure the stylesheet path is correct
})
